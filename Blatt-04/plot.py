...
plt.plot( ort_x_2, ort_y_2 , 'b-' , label=r'$\theta_2=+\sqrt{2}\theta_1$' )
plt.ylim(-2 , -1.98)
plt.xlabel(r'$x/\mathrm{m}$')
plt.ylabel(r'$y/\mathrm{m}$')
plt.grid()
Zeit , theta_1 , theta_2 , theta_V_1 , theta_V_2 , ort_x_1 , ort_y_1 , ort_x_2 , ort_y_2 , Energie_kin , Energie_pot = np.genfromtxt( 'Ergebnisse/Ergebnis_1_C_2.txt' , unpack=True)
plt.plot( ort_x_2, ort_y_2 , 'r-' , label=r'$\theta_2=-\sqrt{2}\theta_1$' )
plt.legend(loc='best')
plt.savefig("Plots/Plot_1_D_trajektorie.pdf")
plt.clf()

Zeit , theta_1 , theta_2 , theta_V_1 , theta_V_2 , ort_x_1 , ort_y_1 , ort_x_2 , ort_y_2 , Energie_kin , Energie_pot = np.genfromtxt( 'Ergebnisse/Ergebnis_1_C_1.txt' , unpack=True)
plt.plot( Zeit, theta_1 , 'b-' , label=r'$\theta_1$' )
plt.xlabel(r'$t/\mathrm{s}$')
plt.ylabel(r'$\theta$')
plt.grid()
Zeit , theta_1 , theta_2 , theta_V_1 , theta_V_2 , ort_x_1 , ort_y_1 , ort_x_2 , ort_y_2 , Energie_kin , Energie_pot = np.genfromtxt( 'Ergebnisse/Ergebnis_1_C_2.txt' , unpack=True)
plt.plot( Zeit, theta_2 , 'r-' , label=r'$\theta_2$' )
plt.legend(loc='best')
plt.savefig("Plots/Plot_1_C_winkel.pdf")
plt.clf()

Zeit , theta_1 , theta_2 , theta_V_1 , theta_V_2 , ort_x_1 , ort_y_1 , ort_x_2 , ort_y_2 , Energie_kin , Energie_pot = np.genfromtxt( 'Ergebnisse/Ergebnis_1_C_1.txt' , unpack=True)
plt.plot( Zeit, theta_V_1 , 'b-' , label=r'$\dot{\theta_1}$' )
plt.xlabel(r'$t/\mathrm{s}$')
plt.ylabel(r'$\dot{\theta}\cdot\mathrm{s}$')
plt.grid()
Zeit , theta_1 , theta_2 , theta_V_1 , theta_V_2 , ort_x_1 , ort_y_1 , ort_x_2 , ort_y_2 , Energie_kin , Energie_pot = np.genfromtxt( 'Ergebnisse/Ergebnis_1_C_2.txt' , unpack=True)
plt.plot( Zeit, theta_V_2 , 'r-' , label=r'$\dot{\theta_2}$' )
plt.legend(loc='best')
plt.savefig("Plots/Plot_1_C_winkelgeschwindigkeit.pdf")
plt.clf()

Zeit , theta_1 , theta_2 , theta_V_1 , theta_V_2 , ort_x_1 , ort_y_1 , ort_x_2 , ort_y_2 , Energie_kin , Energie_pot = np.genfromtxt( 'Ergebnisse/Ergebnis_1_C_1.txt' , unpack=True)
plt.plot(Zeit , Energie_kin , 'r-' , label=r'$E_\mathrm{kin}$' )
plt.plot(Zeit , Energie_pot , 'b-' , label=r'$E_\mathrm{pot}$' )
plt.plot(Zeit , Energie_pot+Energie_kin , 'k-', label=r'$E_\mathrm{ges}$' )
plt.legend(loc='best')
plt.xlabel(r'$\mathrm{Zeit}$ $t/\mathrm{s}$')
plt.ylabel(r'$\mathrm{Energie}$ $E/\mathrm{J}$')
plt.grid()
...
plt.ylabel(r'$\mathrm{Energie}$ $E/\mathrm{J}$')
plt.grid()
plt.savefig("Plots/Plot_1_C_2_energie.pdf")
plt.clf()
...
plt.xlabel( r'$\theta_{1,\mathrm{quasi}}$')
plt.ylabel( r'$\dot{\theta}_{1,\mathrm{quasi}}$')
plt.grid()
...
Zeit , theta_1 , theta_2 , theta_V_1 , theta_V_2 , ort_x_1 , ort_y_1 , ort_x_2 , ort_y_2 , Energie_kin , Energie_pot = np.genfromtxt( 'Ergebnisse/Ergebnis_2_A_2.txt' , unpack=True)
plt.plot(theta_1 , theta_V_1 , 'b-')
plt.xlabel( r'$\theta_{1,\mathrm{chaos}}$')
plt.ylabel( r'$\dot{\theta}_{1,\mathrm{chaos}}$')
plt.grid()
...
Zeit , theta_1 , theta_2 , theta_V_1 , theta_V_2 , ort_x_1 , ort_y_1 , ort_x_2 , ort_y_2 , Energie_kin , Energie_pot = np.genfromtxt( 'Ergebnisse/Ergebnis_1_C_1.txt' , unpack=True)
plt.plot(theta_1 , theta_V_1 , 'b-')
plt.xlabel( r'$\theta_{1,\mathrm{period}}$')
plt.ylabel( r'$\dot{\theta}_{1,\mathrm{period}}$')
plt.grid()
plt.savefig("Plots/Plot_2_A_3_Phasenraum.pdf")
plt.clf()
Zeit , theta_1 , theta_2 , theta_V_1 , theta_V_2 , ort_x_1 , ort_y_1 , ort_x_2 , ort_y_2 , Energie_kin , Energie_pot = np.genfromtxt( 'Ergebnisse/Ergebnis_2_A_1.txt' , unpack=True)
plt.plot(theta_2 , theta_V_2 , 'b-')
plt.xlabel( r'$\theta_2$')
plt.ylabel( r'$\dot{\theta}_2$')
plt.grid()
plt.savefig("Plots/Plot_2_A_4_Phasenraum.pdf")
plt.clf()
...
plt.xlabel( r'$\theta_1$')
plt.grid()
plt.savefig("Plots/Plot_2_C_Chaos.pdf")
